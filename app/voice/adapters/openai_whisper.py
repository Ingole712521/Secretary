...
logger = logging.getLogger(f"{LOGGER_ROOT}.voice.stt")
...
class OpenAiWhisperStt:
    ...
    Requires a direct OpenAI API key (not OpenRouter) for the
    ``/audio/transcriptions`` endpoint.

    Attributes:
        _settings: Application settings.
        _http_client: Optional injected HTTP client for tests.
    """
    ...
    async def transcribe(
        ...
        *,
        ...
        logger.info("Whisper transcription success | length=%d", len(text))
